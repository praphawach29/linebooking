...
const plans = [
  {
    name: 'Starter (ฟรีเริ่มต้น)',
    priceMonthly: 0,
    priceYearly: 0,
    badge: 'ทดลอง Pro ฟรี 14 วัน ⭐',
    popular: false,
    features: [
      'ทดลองใช้งาน Pro ฟรี 14 วัน (ไม่ต้องใช้บัตร)',
      'หลังครบ 14 วัน ฟรีสูงสุด 30 รายการจอง/เดือน',
      'ทีมช่าง/พนักงานสูงสุด 1 คน (1 สนาม)',
      'รองรับระบบจองผ่าน LINE LIFF',
      'แดชบอร์ดจัดการคิวนัดหมาย',
    ],
    ctaText: 'เปิดร้านค้าฟรี',
    highlight: false,
  },
  {
